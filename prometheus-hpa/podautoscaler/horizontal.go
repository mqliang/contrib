...
import (
	...
	typedautoscalingv1 "k8s.io/client-go/1.5/kubernetes/typed/autoscaling/v1"
	corev1 "k8s.io/client-go/1.5/kubernetes/typed/core/v1"
	typedextensionv1beta1 "k8s.io/client-go/1.5/kubernetes/typed/extensions/v1beta1"
	"k8s.io/client-go/1.5/pkg/api"
	"k8s.io/client-go/1.5/pkg/api/resource"
	"k8s.io/client-go/1.5/pkg/api/unversioned"
	autoscalingv1 "k8s.io/client-go/1.5/pkg/apis/autoscaling/v1"
	extensionv1beta1 "k8s.io/client-go/1.5/pkg/apis/extensions/v1beta1"
...
type HorizontalController struct {
	scaleNamespacer typedextensionv1beta1.ScalesGetter
	hpaNamespacer   typedautoscalingv1.HorizontalPodAutoscalersGetter
...
func NewHorizontalController(evtNamespacer corev1.EventsGetter, scaleNamespacer typedextensionv1beta1.ScalesGetter, hpaNamespacer typedautoscalingv1.HorizontalPodAutoscalersGetter, metricsClient metrics.MetricsClient, resyncPeriod time.Duration) *HorizontalController {
	broadcaster := record.NewBroadcaster()
	broadcaster.StartRecordingToSink(&corev1.EventSinkImpl{Interface: evtNamespacer.Events("")})
...
func (a *HorizontalController) computeReplicasForCPUUtilization(hpa *autoscalingv1.HorizontalPodAutoscaler, scale *extensionv1beta1.Scale) (int32, *int32, time.Time, error) {
	...
	selector := labels.SelectorFromSet(scale.Status.Selector)
...
func (a *HorizontalController) computeReplicasForCustomMetrics(hpa *autoscalingv1.HorizontalPodAutoscaler, scale *extensionv1beta1.Scale,
	...
	var targetList extensionv1beta1.CustomMetricTargetList
	...
	statusList := extensionv1beta1.CustomMetricCurrentStatusList{
		Items: make([]extensionv1beta1.CustomMetricCurrentStatus, 0),
	}
	...
	for _, customMetricTarget := range targetList.Items {
		...
		statusList.Items = append(statusList.Items, extensionv1beta1.CustomMetricCurrentStatus{
...
func (a *HorizontalController) reconcileAutoscaler(hpa *autoscalingv1.HorizontalPodAutoscaler) error {
...
func (a *HorizontalController) updateCurrentReplicasInStatus(hpa *autoscalingv1.HorizontalPodAutoscaler, currentReplicas int32) {
...
func (a *HorizontalController) updateStatus(hpa *autoscalingv1.HorizontalPodAutoscaler, currentReplicas, desiredReplicas int32, cpuCurrentUtilization *int32, cmStatus string, rescale bool) error {
